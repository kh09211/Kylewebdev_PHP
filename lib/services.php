	...
	<div class="row justify-content-center mt-2">
		<div class="col-md-4">
			<div class="text-center">
				<img class="img-fluid icon my-4" src="media/gearicon_blue.png" alt="gear icon">
				<br>
				<b>Web Development</b>
			</div>
			<ul class="mt-4 mr-1">
		...
		<div class="col-md-4">
			<div class="text-center mb-2">
				<img class="img-fluid icon mt-3 aws" src="media/aws_logo2.png" alt="gear icon">
				<br>
				<b>Hosting and AWS</b>
			</div>
			<ul class="mt-4 mr-1">
		...
		<div class="col-md-4">
			<div class="text-center">
				<img class="img-fluid icon my-4" src="media/lock_blue.png" alt="gear icon">
				<br>
